...
#endif
{
 ...
 static ograd *
#ifdef KR_headers
new_og(S, next, i, v) Static *S; ograd *next; int i; real v;
#else
...
#endif
{
 ...
 static ograd *
#ifdef KR_headers
ogdup(S, og, oge) Static *S; ograd *og, **oge;
#else
...
#endif
{
 ...
 static int
#ifdef KR_headers
count(S, ogp) Static *S; ograd **ogp;
#else
...
#endif
{
 ...
 static dyad *
#ifdef KR_headers
new_dyad(S, next, L, R, permute) Static *S; dyad *next; ograd *L, *R; int permute;
#else
...
#endif
{
 ...
 static term *
#ifdef KR_headers
termsum(S, L, R) Static *S; term *L, *R;
#else
...
#endif
{
 ...
 static term *
#ifdef KR_headers
scale(S, T, t) Static *S; term *T; register double t;
#else
...
#endif
{
 ...
 static double
#ifdef KR_headers
dsort(S, T, q, cgp, ogp, arrays)
	Static *S; term *T; ograd **q, **ogp; cgrad **cgp; int arrays;
#else
...
#endif
{
 ...
 static void
#ifdef KR_headers
free_oglist(S, og) Static *S; ograd *og;
#else
...
#endif
{
 ...
 static void
#ifdef KR_headers
cterm_free(S, cte) Static *S; term **cte;
#else
...
#endif
{
 ...
 fint
#ifdef KR_headers
mqpcheck_ASL(a, co, rowqp, colqp, delsqp)
 ASL *a; int co;  fint **rowqp,**colqp; real **delsqp;
#else
...
#endif
{
 ...
 fint
#ifdef KR_headers
nqpcheck_ASL(asl, co, rowqp, colqp, delsqp)
 ASL *asl; int co;  fint **rowqp,**colqp; real **delsqp;
#else
