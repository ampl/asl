...
associated with the above keywords.
        ...
        crossoveritlim          XPRS_CROSSOVERITERLIMIT
        ...
        heurforcespecobj        XPRS_HEURFORCESPECIALOBJ
...
-----------------------
Use with a FICO license
=======================

Normally the xpress program uses AMPL's licensing system, but
(starting with version 20181224) it will also work with a license file
provided by FICO when that file is specified in shell variable XPRESS.
