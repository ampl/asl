...
f_OP_exp(expr *e A_ASL)
{
	...
	e1 = e->L.e;
	rv.d = e->dL = e->dL2 = exp(t = (*e1->op)(e1 K_ASL));
	if (errchk(rv)) {
		if (t >= 0.)
			introuble("exp",t,1);
		else {
